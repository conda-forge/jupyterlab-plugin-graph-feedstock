...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyterlab-plugin-graph-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13965&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyterlab-plugin-graph-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyterlab-plugin-graph` can be installed with:

```
conda install jupyterlab-plugin-graph
```

It is possible to list all of the versions of `jupyterlab-plugin-graph` available on your platform with:
